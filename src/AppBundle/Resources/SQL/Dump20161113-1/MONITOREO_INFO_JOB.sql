...
CREATE TABLE `INFO_JOB` (
  ...
  `NOMBRE_JOB` varchar(80) NOT NULL,
  `ESTADO` varchar(20) NOT NULL,
  `FE_EJECUCION` datetime NOT NULL,
  ...
  CONSTRAINT `SCRIPT_ID` FOREIGN KEY (`SCRIPT_ID`) REFERENCES `INFO_SCRIPT` (`ID_SCRIPT`) ON DELETE NO ACTION ON UPDATE NO ACTION
